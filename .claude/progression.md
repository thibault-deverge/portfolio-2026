...
- [ ] C1 ⚙️ Structure 3 lignes (muted/italique/accent) + i18n refondu (t.rich) + verdict D2 (dérive)
- [ ] C2 ⚙️ Reveals masqués recalés sur la levée
- [ ] C3 ⚙️ ScrambleText (eyebrow) — îlot client SSR-safe
